...
const defaultSteps = [
  { number: "01", icon: "ClipboardCheck", title: "প্রজেক্ট ম্যানেজার", subtitle: "পরিকল্পনা ও সমন্বয়", description: "আপনার প্রজেক্টের জন্য একজন ডেডিকেটেড প্রজেক্ট ম্যানেজার থাকেন যিনি পুরো কাজের পরিকল্পনা করেন, টাইমলাইন সেট করেন এবং টিমের সাথে সমন্বয় রাখেন।" },
  { number: "02", icon: "PenTool", title: "গ্রাফিক্স ডিজাইনার", subtitle: "ক্রিয়েটিভ ডিজাইন", description: "ডেডিকেটেড ডিজাইনার আপনার ব্র্যান্ডের লোগো, ব্যানার, সোশ্যাল মিডিয়া পোস্ট এবং UI/UX ডিজাইন করেন।" },
  { number: "03", icon: "Code", title: "ওয়েব ডেভেলপার", subtitle: "ডেভেলপমেন্ট ও টেক", description: "এক্সপার্ট ডেভেলপার আপনার ওয়েবসাইট তৈরি করেন, হোস্টিং সেটআপ করেন এবং টেকনিক্যাল সব কিছু সামলান।" },
  { number: "04", icon: "Megaphone", title: "ডিজিটাল মার্কেটার", subtitle: "মার্কেটিং ও গ্রোথ", description: "ডেডিকেটেড মার্কেটার SEO, সোশ্যাল মিডিয়া ম্যানেজমেন্ট এবং অ্যাড ক্যাম্পেইন চালান।" },
];
            ...
            {steps.map((step: any, i: number) => {
              ...
              return (
                <motion.div
                  ...
                  className={`lg:grid lg:grid-cols-2 lg:gap-16 lg:py-12 items-center ${isEven ? "" : "lg:direction-rtl"}`}
                >
